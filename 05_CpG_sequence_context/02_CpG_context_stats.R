...
dir.create("/datasets/work/hb-stopwatch/work/cpgberus/05_CpG_sequence_context/02_outputs")
...
# Save workspace
save(Not_rarefied_common_bsseq, Not_rarefied_common_stats_smooth, Not_rarefied_common_stats_no_smooth, file = "/datasets/work/hb-stopwatch/work/cpgberus/05_CpG_sequence_context/02_outputs/Not_rarefied_CpG_stats_common.RData")
...
# Save workspace
save(Rarefied_common_bsseq, Rarefied_common_stats_smooth, Rarefied_common_stats_no_smooth, file = "/datasets/work/hb-stopwatch/work/cpgberus/05_CpG_sequence_context/02_outputs/Rarefied_CpG_stats_common.RData")
